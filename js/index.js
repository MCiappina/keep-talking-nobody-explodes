        ...
        this.wiresModule.wires.forEach((e) => {
            const handler = () => {
                if (e.correctWire) {
                    ...
                    wireDiv.firstElementChild.classList.add("cut-left");
                    wireDiv.lastElementChild.classList.add("cut-right");
                    ...
                    for (let i = 0; i < wireList.length; i++) {
                        ...
                        elClone.firstElementChild.classList.remove("hoverable-first-half");
                        elClone.lastElementChild.classList.remove("hoverable-second-half");
                    ...
                    wireDiv.lastElementChild.classList.add("cut-right");
                    wireDiv.removeEventListener("click", handler);
                    wireDiv.removeEventListener("mousenter", applyHoverWires);
                    wireDiv.removeEventListener("mouseleave", removeHoverWires);
                    wireDiv.firstChild.classList.remove("hoverable-first-half");
                    wireDiv.lastChild.classList.remove("hoverable-second-half");

                    this.checkGameover();
                }
            };

            const applyHoverWires = (event) => {
                if (!event.target.firstElementChild.classList.contains("cut-left")) {
                    event.target.firstElementChild.classList.add("hoverable-first-half");
                    event.target.lastElementChild.classList.add("hoverable-second-half");
                }
            };

            const removeHoverWires = (event) => {
                console.log("removeHoverWire fired");
                event.target.firstElementChild.classList.remove("hoverable-first-half");
                event.target.lastElementChild.classList.remove("hoverable-second-half");
            };

            let wireDiv = e.wireAsDiv();
            wireModule.appendChild(wireDiv);
            wireDiv.addEventListener("mouseenter", applyHoverWires);
            wireDiv.addEventListener("mouseleave", removeHoverWires);
